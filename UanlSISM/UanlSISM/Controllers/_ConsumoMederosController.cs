...
{
    public class _ConsumoMederosController : Controller
    {
        // GET: ConsumoMederos
        public ActionResult _ConsumoMederos()
        {
            SERVMEDEntities5 Inv = new SERVMEDEntities5();
            var repsustancia = Inv.Database.SqlQuery<_ConsumoMederos>("EXEC Sp_ReporteMederos").ToList();
