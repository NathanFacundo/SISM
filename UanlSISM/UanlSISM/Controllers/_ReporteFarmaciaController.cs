...
{
    public class _ReporteFarmaciaController : Controller
    {
        // GET: _ReporteFarmacia
        public ActionResult _ReporteFarmacia()
        {
            SERVMEDEntities1 Inv = new SERVMEDEntities1();
            var res = Inv.Database.SqlQuery<_ConsumoFar>("EXEC Sp_ReporteConsumoFarm").ToList();
