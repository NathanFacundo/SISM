...
{
    public class _ConsumoSEMACController : Controller
    {
        // GET: _ConsumoSEMAC
        public ActionResult _ConsumoSEMAC()
        {
            SERVMEDEntities5 Inv = new SERVMEDEntities5();
            var repsustancia = Inv.Database.SqlQuery<_ConsumoSEMAC>("EXEC Sp_ReporteSEMAC").ToList();
